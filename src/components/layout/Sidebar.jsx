...
import { Code2, Database, Brain, Lightbulb, ChevronLeft, ChevronRight, Zap } from 'lucide-react'
...
export default function Sidebar({ collapsed, onToggleCollapse }) {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="flex items-center gap-3 px-5 h-16 border-b border-gray-200 dark:border-slate-700 shrink-0">

...
export default function RoadmapSidebar({ topics, currentSlug, completedSlugs, routePrefix = '/ml' }) {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <div className="px-5 py-4 border-b border-gray-200 dark:border-slate-700 shrink-0">
      ...
      <nav className="flex-1 overflow-y-auto scrollbar-thin py-2 px-3">
        {topics.map((topic, index) => {
          ...
          return (
            <button
              key={topic.slug}
              onClick={() => navigate(`${routePrefix}/${topic.slug}`)}
              className={`

    ...
    <div className="flex items-center justify-between px-4 py-2 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 shrink-0">
      ...
      <div className="flex items-center gap-2">
        <div className="relative">
          ...
          {showDropdown && (
            <div className="absolute left-0 top-full mt-1 w-48 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-gray-200 dark:border-slate-600 py-1 z-50 animate-fade-in">
              <button
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-mono text-gray-600 dark:text-gray-400 min-w-[100px] text-center">
